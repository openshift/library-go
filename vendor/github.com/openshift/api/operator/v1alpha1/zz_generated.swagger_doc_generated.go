...
var map_EtcdBackupJob = map[string]string{
	"name":      "name of the backup job",
	"namespace": "namespace of the backup job",
	"uid":       "uid of the backup job",
}

func (EtcdBackupJob) SwaggerDoc() map[string]string {
	return map_EtcdBackupJob
}
...
var map_EtcdBackupStatus = map[string]string{
	...
	"filePath":   "filePath is the absolute path to the backup file on the storage backend.",
	"fileSize":   "fileSize is the size of the backup file on the storage backend.",
}
...
var map_EtcdBackupPolicySpec = map[string]string{
	...
	"timeZone":       "The time zone name for the given schedule, see https://en.wikipedia.org/wiki/List_of_tz_database_time_zones. If not specified, this will default to the time zone of the cluster-etcd-operator process.",
