...
func WaitForPodsToStabilizeOnTheSameRevision(t TestingT, podClient corev1client.PodInterface, podLabelSelector string, waitForRevisionSuccessThreshold int, waitForRevisionSuccessInterval, waitForRevisionPollInterval, waitForRevisionTimeout time.Duration) error {
...
func arePodsOnTheSameRevision(t TestingT, podClient corev1client.PodInterface, podLabelSelector string) (bool, error) {
