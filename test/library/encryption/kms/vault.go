...
var DefaultVaultKMSPluginConfig = configv1.APIServerEncryption{
	...
	KMS:  configv1.KMSPluginConfig{Type: configv1.VaultKMSProvider, PluginConfig: configv1.KMSPluginConfigReference{APIVersion: "kms.openshift.io/v1alpha1", Resource: "vaultkmsconfigs", Name: "vault"}},
}
...
var SecondaryVaultKMSPluginConfig = configv1.APIServerEncryption{
	Type: configv1.EncryptionTypeKMS,
	KMS:  configv1.KMSPluginConfig{Type: configv1.VaultKMSProvider, PluginConfig: configv1.KMSPluginConfigReference{APIVersion: "kms.openshift.io/v1alpha1", Resource: "vaultkmsconfigs", Name: "vault-secondary"}},
}
