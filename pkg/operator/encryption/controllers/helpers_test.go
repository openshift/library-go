...
func kmsConfigReference(config kms.KMSPluginConfig) configv1.KMSPluginConfig {
	return configv1.KMSPluginConfig{Type: configv1.KMSProviderType(config.Type), PluginConfig: configv1.KMSPluginConfigReference{APIVersion: "kms.openshift.io/v1alpha1", Resource: "vaultkmsconfigs", Name: "cluster"}}
}
