...
// KMSProviderConfig decouples the KMS plugin lifecycle from the APIServer API so that
// controllers can manage plugin deployment (image, volumes, sockets) independently of
