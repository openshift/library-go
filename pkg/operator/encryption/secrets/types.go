...
const (
	...
	// SecretDataKeySeparator separates the secret name from the data key in
	// Key Secret data keys. Underscore is used because it is forbidden in
	// Kubernetes secret/configmap names, preventing collisions.
