...
// This package will be removed when the referenced PR merges.
package api
...
// GetKMSProviderConfig returns KMSConfigAPI that is the representation of API
// TODO: these hardcoded data will be replaced by API when it is ready
func GetKMSProviderConfig() *KMSConfigAPI {
	return &KMSConfigAPI{
		Type: VaultKMSProvider,
