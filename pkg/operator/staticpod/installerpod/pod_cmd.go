...
func (o *InstallOptions) toCertCopyOptions() *CertCopyOptions {
	...
	certCopy.NameFn = func(name string) string {
		return nameFor(name, o.Revision)
	}
	return certCopy
}

func (o *InstallOptions) copyContent(ctx context.Context) error {
	certCopyOptions := o.toCertCopyOptions()
	if err := certCopyOptions.copyContent(ctx); err != nil {
		return err
	}
