...
type staticPodOperatorControllerBuilder struct {
	...
	deployStartupMonitor     func() (bool, error)
...
type Builder interface {
	...
	WithStartupMonitorPredicate(shouldDeployStartupMonitor func() (bool, error)) Builder
...
func (b *staticPodOperatorControllerBuilder) WithStartupMonitorPredicate(shouldDeployStartupMonitor func() (bool, error)) Builder {
	b.deployStartupMonitor = shouldDeployStartupMonitor
	return b
}
