...
// Interface performs verification of the provided content and provides access to a copy of any cached
// signatures that have been validated thus far. The default implementation
...
// is always returned.
func LoadConfigMapVerifierDataFromUpdate(manifests []manifest.Manifest, clientBuilder ClientBuilder) (Interface, error) {
