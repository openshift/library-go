...
func TestValidityPeriodOfClientCertificate(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("passed=%v,real=%v", test.passedDuration, test.realDuration), func(t *testing.T) {
			cert := NewClientCertificateTemplate(pkix.Name{CommonName: "client"}, test.passedDuration, currentFakeTime)
