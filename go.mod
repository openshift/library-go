...
replace (
	github.com/openshift/api => github.com/jubittajohn/api v0.0.0-20260625215438-299cf96e3301
	github.com/openshift/client-go => github.com/jubittajohn/client-go v0.0.0-20260625221110-0ed9348d057d
)
