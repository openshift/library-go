...
replace (
	github.com/openshift/api => github.com/jacobsee/openshift-api v0.0.0-20251119030923-1e4d8ce277fd
	github.com/openshift/client-go => github.com/jacobsee/client-go v0.0.0-20251119215545-d21e2aa3b482
)
