...
replace (
	github.com/openshift/api => github.com/bertinatto/api v0.0.0-20250401164618-1203d4e93857
	github.com/openshift/client-go => github.com/bertinatto/client-go v0.0.0-20250401170358-6d78be609005
)
