...
replace (
	github.com/openshift/api => github.com/jacobsee/openshift-api v0.0.0-20251219002020-a018c47c57ab
	github.com/openshift/client-go => github.com/jacobsee/client-go v0.0.0-20251219003049-54e1a4c7407c
)
