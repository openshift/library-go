...
require (
	...
	k8s.io/kube-aggregator v0.33.0-rc.0
...
replace github.com/openshift/api => github.com/kevinrizza/api-1 v0.0.0-20250411132903-9c94f454b0fa

replace github.com/openshift/client-go => github.com/kevinrizza/client-go v1.33.0-beta.1.0.20250411150831-52d16d91a917
