...
replace (
	github.com/openshift/api => github.com/jacobsee/openshift-api v0.0.0-20260916172300-f687695525db
	github.com/openshift/client-go => github.com/jubittajohn/client-go v0.0.0-20260916175424-6f78d1b2d8c5
)
