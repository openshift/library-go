...
replace (
	github.com/openshift/api => github.com/bertinatto/api v0.0.0-20250327162654-9c3db9a3930e
	github.com/openshift/client-go => github.com/bertinatto/client-go v0.0.0-20250327163758-b59d42a9fde2
)
