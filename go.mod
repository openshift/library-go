...
require (
	...
	k8s.io/kube-aggregator v0.35.0-rc.1
...
replace (
	github.com/openshift/api => github.com/jacobsee/openshift-api v0.0.0-20251211222145-e9808546b1e4
	github.com/openshift/client-go => github.com/jacobsee/client-go v0.0.0-20251211223129-237ad264f207
)
