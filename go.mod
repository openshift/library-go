...
replace (
	github.com/openshift/api => github.com/bertinatto/api v0.0.0-20250620181603-88dc190bc89e
	github.com/openshift/client-go => github.com/bertinatto/client-go v0.0.0-20250620182545-1fe77d548d8a
)
