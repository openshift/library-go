...
require (
	...
	k8s.io/kube-aggregator v0.37.0-rc.1
...
replace (
	github.com/openshift/api => github.com/jacobsee/openshift-api v0.0.0-20260821003117-1f6e3c8527ef
	github.com/openshift/client-go => github.com/jubittajohn/client-go v0.0.0-20260821164434-c034c022d29f
)
