...
replace (
	github.com/openshift/api => github.com/jacobsee/openshift-api v0.0.0-20260128003014-e5e4e1372c14
	github.com/openshift/client-go => github.com/jacobsee/client-go v0.0.0-20260128010417-b654831474e1
)
