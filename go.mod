...
replace github.com/openshift/api => github.com/kevinrizza/api-1 v0.0.0-20250424181857-59a940bca71b

replace github.com/openshift/client-go => github.com/kevinrizza/client-go v1.33.0-beta.1.0.20250425201751-de0cad97874a
